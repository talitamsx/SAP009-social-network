...
const fazerCadastro = async (name2, email, password) => {
  console.log(name2, email, password);
...
const logo = "/assets/logo-lemos.8c3b1bc8.png";
const menina$1 = "/assets/lemos-figura.c947701b.png";
const google = "/assets/figura-google.3f54b946.png";
const login = () => {
  ...
  <main class="conteudo-pagina">
    ...
    <div class = "figura-menina-texto">
      <p class="descricao">Fa\xE7a parte da Le<span style= "color:#FF7373;">m</span>os , a maior rede social de incentivo e compartilhamento de leitura feminista! </p>
      <img class="menina-lemos" src=${menina$1}>
    </div>
    <form class="form-login">
        ...
        <p class="texto-cadastro">Ainda n\xE3o faz parte? <br> <a href="#cadastro">Cadastre-se aqui!</p></a>
      </form>
   </section>
      <dialog class="modal"> Usu\xE1rio ou senha incorretos
...
const db = hh(app);
const database = async (name2, email) => {
  try {
    const docRef = await nf(Xa(db, "users"), {
      name: name2,
      email
    });
...
const pegarPost = async (mostrarPost) => {
  const q2 = al(Xa(db, "posts"), ml("date", "desc"));
  await sf(q2, (querySnapshot) => {
...
const fazerPost = async (titulo, autora, post, nivel) => {
  const auth2 = getAuth(app);
  try {
    const dataPostagem = new Date();
    const docRef = await nf(Xa(db, "posts"), {
...
const curtirPost = async (postId, userId) => tf(eh(db, "posts", postId), {
  likesUsuaria: gf(userId)
});
const descurtirPost = async (postId, userId) => tf(eh(db, "posts", postId), {
  likesUsuaria: yf(userId)
});
const excluirPost = async (postId) => ef(eh(db, "posts", postId));
const editarPost = async (postId, editarTexto) => tf(eh(db, "posts", postId), {
  post: editarTexto
});
const cadastro = () => {
  const container = document.createElement("div");
  ...
  formCadastro.addEventListener("submit", (event) => {
    ...
    fazerCadastro(cadastroNome.value, cadastroEmail.value, cadastroSenha.value).then(() => {
...
const feed = () => {
  ...
  <main class="feed-post">
    <div class = "nome-usuaria">
      ...
      <h3>Ol\xE1, ${auth.currentUser.displayName} !</h3>
    </div>
    <section class="nome-livro">
      <h2 class="criar-post">Criar publica\xE7\xE3o</h2>
      <p>T\xEDtulo do livro</p>
    ...
    <section class="nivel-leitura">
      <p>Para qual leitora voc\xEA indica esse livro?</p>
      <div class="botoes-nivel">        
        <input type="radio" class="inicante" value="iniciante" name="nivel">
        <label for="iniciante">iniciante</label>
        <input type="radio" class="intermediaria" value="intermedi\xE1ria" name="nivel">
        <label for="intermediaria">intermedi\xE1ria</label>
        <input type="radio" class="avancada" value="avan\xE7ada" name="nivel">
        <label for="avancada">avan\xE7ada</label>
      </div>
    </section>
    ...
    <div>
      <h3 class="texto-ultimos-posts">\xDAltimas publica\xE7\xF5es</h3>
  ...
  const exibirPostagem = () => {
    ...
    <section class="publicacao">
      <p class="titulo-post">T\xEDtulo do Livro: <strong>${post.titulo}</strong></p>
    ...
    <div id="botao-like" class="display">
     ...
     <button id="botao-salvar" class="hidden">Salvar</button>
      ...
      botaoExcluir.addEventListener("click", () => {
        if (window.confirm("Tem certeza que deseja excluir a publica\xE7\xE3o?")) {
...
const menina = "/assets/lemos-sobre.3c6d1a3a.png";
const sobre = () => {
  const container = document.createElement("div");
  const template = `
  ...
  <section class="conteudo-sobre">
    <h2 class="sobre">A Le<span style= "color:#FF7373;">m</span>os \xE9 uma rede social que surgiu a partir da 
    identifica\xE7\xE3o da vontade das mulheres em aumentar ou iniciar um 
    repert\xF3rio de leitura com tem\xE1tica feminista. Pensando nisso, 
    desenvolvemos esse projeto para publicar informa\xE7\xF5es pontuais e 
    coment\xE1rios que facilitem a divulga\xE7\xE3o de livros, autoras e tamb\xE9m 
    indiquem o n\xEDvel de leitura: inciante, intermedi\xE1rio ou avan\xE7ado. <br>
    Fa\xE7a seu cadastro e venha compartilhar com a gente!</h2>
